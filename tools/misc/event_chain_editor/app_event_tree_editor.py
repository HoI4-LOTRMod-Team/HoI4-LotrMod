...
def main():
    ...
    focus_node_tree = FocusNodeTree(graph,
        BASE_PATH / r'events\ring_events.txt',
        #BASE_PATH / r'localisation\english\0_lotr_core\lotr_temp_l_english.yml'
        BASE_PATH / r'localisation\english\0_lotr_core\lotr_ring_l_english.yml',
