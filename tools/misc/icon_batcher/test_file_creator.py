...
prompt_template = """I need an element that will be used to make icons for a LOTR-related game. The icons will be quite small, so the images you generate should have clear, while the tiny details are less important. They should all be on a flat/neutral background, as they are only elements/components.
...
Understood? Great! Now, give me one for the following: 
PROMPT
"""


prompt_list = [
    "A medieval soldier with a halberd",
