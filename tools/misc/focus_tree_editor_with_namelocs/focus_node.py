...
class FocusNode(BaseNode):
    ...
    def __setattr__(self, name, value):
        ...
        if self.is_activated and hasattr(self, name):
            ...
            if old_value != value:
                ...
                if name == "lname":
                    self.parent_tree.locfile.set(self.focus_id, value)
    ...
    def post_init(self):
        ...
        if self.parent_tree.locfile.contains(self.focus_id):
            self.lname = self.parent_tree.locfile.get(self.focus_id)
            self.update_label()
    ...
    def get_properties(self):
        ...
        return [
            ...
            StringProperty("Loc Name", attr_name="lname"),
            StringProperty(
