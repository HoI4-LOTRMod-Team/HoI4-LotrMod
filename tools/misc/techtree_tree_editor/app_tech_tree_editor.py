...
from tech_node_tree import TechNodeTree
...
def main():
    ...
    tech_node_tree = TechNodeTree(graph)
    graph.tech_tree = tech_node_tree

    context_menu = graph.get_context_menu('graph')
    main_window = create_main_window()
    main_window.setCentralWidget(graph.widget)
    dock_widget = create_properties_panel(main_window, graph, tech_node_tree)
