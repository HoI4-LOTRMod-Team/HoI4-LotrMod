...
NProduction = {
	MAX_CIV_FACTORIES_PER_LINE = 12
}

-- Tension related defines
NDiplomacy = {
    TENSION_NO_CB_WAR = 15,							-- Amount of tension generated by a no-CB wargoal : base value 15
	TENSION_CB_WAR = 10,								-- Amount of tension generated by a war with a CB : base value 7
    TENSION_TIME_SCALE_START_DATE = "3018.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
}